...
$sql = "SELECT p.id, p.resi, u.name AS user_name, c.name AS courier_name, p.description, p.pickup_address, p.delivery_address, ps.status_name, p.shipper, p.recipient, p.created_at, p.updated_at
FROM packages AS p
INNER JOIN users AS u ON p.user_id = u.id
INNER JOIN couriers AS c ON p.courier_id = c.id
INNER JOIN package_statuses AS ps ON p.current_status_id = ps.id ORDER BY 
    p.created_at DESC";
                            ...
                            <div class="card-body p-4">
                                <div class="row align-items-center">
                                    <div class="col d-flex justify-content-between">
                                        <h5 class="card-title fw-semibold mb-4">Packages Data</h5>
