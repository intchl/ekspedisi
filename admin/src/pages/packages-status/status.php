...
$sql = "SELECT id, status_name FROM package_statuses";
                            ...
                            <div class="card-body p-4">
                                <div class="row align-items-center">
                                    <div class="col d-flex justify-content-between">
                                        <h5 class="card-title fw-semibold mb-4">Packages Statuses</h5>
                                        <a href="add-status.php" class="btn btn-primary m-1">
                                            ...
                                            if ($result->num_rows > 0): ?>
                                                <?php while ($row = $result->fetch_assoc()): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <!-- Edit Button -->
                                                            <a href="edit-status.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm">
                                                                <i class="ti ti-pencil"></i>
                                                            </a>
                                                            <!-- Delete Button -->
                                                            <a href="delete-status.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this status?')">
