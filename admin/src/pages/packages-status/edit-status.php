...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM package_statuses WHERE id = ?";
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $updateQuery = "UPDATE package_statuses SET status_name = ? WHERE id = ?";
        $updateStmt = $conn->prepare($updateQuery);
        $updateStmt->bind_param("si", $status_name, $id); // bind status_name and id
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-4">Edit Status</h5>
                        <div class="card">
                            <div class="card-body">
                                <form method="POST">
                                    <div class="mb-3">
