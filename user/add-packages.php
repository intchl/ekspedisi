      ...
      <div class="container">
        <form method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="courier_id" name="courier_id" value="8" required hidden />
          </div>
          ...
          <div class="mb-3">
            <!-- <label for="courier_id" class="form-label">Courier</label> -->
            <input type="text" class="form-control" id="current_status_id" name="current_status_id" value="1" required hidden />
          </div>
